...
class RF():
    ...
    def read(self):
        ...
        packet.y = (components[9], components[10], components[11], components[12])
        packet.x = (components[13], components[14], components[15], components[16], components[17], components[18])
        packet.dx = (components[19], components[20], components[21], components[22], components[23], components[24])
